...
export const Grid = ({ blogGrid: { core, posts }, shape }) => {
  ...
  const [gridAutoRows, assignRef, adjustMasonry] = useGridMasonry(row_unit, grid_gap, [repaint, setRepaint])
  ...
  return (
    <>
      ...
      <GridItems pieces={{ grid_gap, gridAutoRows, data, assignRef, adjustMasonry, shape }} />
    </>
  )
}
