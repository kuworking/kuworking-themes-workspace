...
export default {
  ...
  modes: {
    dark: {
      cta__div__background: 'linear-gradient(52deg,#222639 60%,#6f42b7 80%,#340082 100%)',
    ...
    tosh: {
      cta__div__background: 'linear-gradient(52deg,#fbfbfb 50%,#f7f7f7 80%,#f3f3f3 100%)',
